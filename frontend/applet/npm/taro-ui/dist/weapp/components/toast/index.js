  ...
  [621], {
    ...
    3345: function(t, n, a) {
      ...
      function c() {
        ...
        return (e = t = S(this, (e = c.__proto__ || Object.getPrototypeOf(c)).call.apply(e, [this].concat(a)))).$usedState = ["anonymousState__temp", "anonymousState__temp2", "_isOpened", "hasMask", "bodyClass", "realImg", "isRenderIcon", "iconClass", "text", "customStyle", "icon", "status", "image", "className", "isOpened", "duration"], t.handleClick = function(e) {
          var n, a = (n = t.props).onClick;
          if ("loading" !== (n = n.status)) return a ? t.props.onClick(e) : void t.close()
        ...
        value: function(e) {
          ...
          var t = e.isOpened;
          e = e.duration;
          t && this.makeTimer(e || 0), this._timer = null, this.state = {
            _isOpened: t
        ...
        key: "close",
        value: function() {
          this.state._isOpened && (this.setState({
            _isOpened: !1
        ...
        value: function(e) {
          ...
          t ? (this.state._isOpened ? this.clearTimmer() : this.setState({
            _isOpened: !0
          }), this.makeTimer(e || 0)) : this.close()
        }
      }, {
        key: "_createData",
        value: function() {
          this.__state = arguments[0] || this.state || {}, this.__props = arguments[1] || this.props || {}, this.$prefix;
          var e = this.__state._isOpened,
            t = (u = this.__props).customStyle,
            n = u.text,
            a = u.icon,
            s = u.status,
            i = u.image,
            ...
            S = !(!a || i || A[s]);
          i = r()("toast-body", p({
            "at-toast__body--custom-image": i,
            "toast-body--text": !l && !a
          }, "at-toast__body--" + s, !!s)), s = r()("at-icon", p({}, "at-icon-" + a, a)), a = e ? r()("at-toast", this.__props.className) : null, e = e ? Object(o.internal_inline_style)(t) : null;
      ...
      }]), u = i = c, i.$$events = ["handleClick"], i.$$componentPath = "node_modules/taro-ui/dist/weapp/components/toast/index", (i = u).defaultProps = {
        duration: 3e3,
        isOpened: !1
      }, i.propTypes = {
        text: n.a.string,
