  ...
  [65], {
    ...
    3472: function(e, a, o) {
      ...
      function c() {
        ...
        return (t = e = u(this, (e = c.__proto__ || Object.getPrototypeOf(c)).call.apply(e, [this].concat(o)))).$usedState = ["itemDataNew", "isMoreOperationShow", "itemIndex", "itemData"], e.config = {
          component: !0
      ...
      r = a()({
        ...
        methods: {
          imageLoad: function(t) {
            var e;
            t = (t = t.detail.width / (t.detail.height || 0)) <= .3 ? (e = 260, 360) : .3 < t && t < 1 ? (e = 360 * t, 360) : 1 <= t && t <= 1.5 ? (e = 360) / t : 1.5 < t && t <= 2.5 ? (e = 510) / t : (e = 510, 200);
          ...
          toDetail: function(t) {
            ...
            this.data.isLogin || 1 != e ? (this.toNewsDetail(t), n.a.setStorageSync("infodetailComment", !0)) : this.triggerEvent("changeShowlogin", !1, {
              bubbles: !1
            })
          },
          awesome: function(t) {
            var e = this,
              ...
              r = this.data.itemDataNew;
            a.data.isLogin && !r.praise && (r.showLikeGif = !0, this.setData({
              itemDataNew: r
            }), setTimeout((function() {
              r.showLikeGif = !1, a.setData({
                itemDataNew: r
              })
            }), 1e3)), a.data.isLogin ? i.a.xyb_request("client/question/SaveInformation!praiseData.action", "POST", {
              id: o,
              status: n ? 0 : 1
            }, !0, !1).then((function(t) {
          ...
          moreOperation: function(t) {
            var e = this;
            n.a.createSelectorQuery().in(this.$scope).select(".moreOperationImg").boundingClientRect((function(a) {
              a && a.top ? n.a.setStorageSync("moreOperation_positionY", a.top) : n.a.setStorageSync("moreOperation_positionY", t.touches[0].clientY), e.data.isLogin ? e.triggerEvent("showMoreOperation", e.data.itemData, {
                bubbles: !1
        ...
        value: function(t) {
          ...
          })(c.prototype.__proto__ || Object.getPrototypeOf(c.prototype), "_constructor", this).call(this, t), this.$$refs = new n.a.RefsArray
        }
      }, {
        key: "_createData",
        value: function() {
          var t = this,
            e = (i = (this.__state = arguments[0] || this.state || {}, this.__props = arguments[1] || this.props || {}, this.$prefix, this.data)).itemDataNew,
            a = i.isMoreOperationShow,
            o = i.itemIndex,
            i = i.itemData;
          return this.anonymousFunc0 = function(e) {
            e.stopPropagation(), n.a.eventCenter.trigger("taroClick", {
              funName: "查看资讯详情"
            }), t.toNewsDetail(e)
      ...
      }]), r = a = c, a.$$events = ["anonymousFunc0", "anonymousFunc1", "imageLoad", "listImgError", "anonymousFunc2"], a.$$componentPath = "components/item-information/item-information", a = r)) || a, Component(o(0).default.createComponent(r))
    },
    654: function(t, e, a) {
