      ...
      Object(e.a)({
        ...
        methods: {
          ...
          adjustIndex: function(t) {
            for (var e = this.data, n = t = Object(i.c)(t, 0, e.count); n < e.count; n++)
              if (!this.isDisabled(e.options[n])) return n;
            for (var s = t - 1; 0 <= s; s--)
              if (!this.isDisabled(e.options[s])) return s
          },
