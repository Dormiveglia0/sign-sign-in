    ...
    1876: function(t, e, i) {
      ...
      Object(e.a)({
        ...
        relation: {
          ...
          unlinked: function(t) {
            t = this.child.indexOf(t);
            var e = this.data.tabs;
            e.splice(t, 1), this.child.splice(t, 1), this.updateTabs(e)
          }
        },
        props: {
          color: String,
        ...
        methods: {
          ...
          onTap: function(t) {
            t = t.currentTarget.dataset.index, this.data.tabs[t].disabled ? this.trigger("disabled", t) : (this.trigger("click", t), this.setActive(t))
          },
          ...
          setLine: function(t) {
            ...
            "line" === this.data.type && (e = this.data, i = e.color, n = e.active, a = e.duration, s = e.lineWidth, o = e.lineHeight, this.getRect(".van-tab", !0).then((function(e) {
              var c, h, l = e[n];
              l && (c = -1 !== s ? s : l.width / 2, h = -1 !== o ? "height: " + o + "px;" : "", e = e.slice(0, n).reduce((function(t, e) {
                return t + e.width
          ...
          onTouchEnd: function() {
            var t, e, i, n, a;
            this.data.swipeable && (t = (e = this.data).active, e = e.tabs, i = this.direction, n = this.deltaX, a = this.offsetX, "horizontal" === i) && 50 <= a && (0 < n && 0 !== t ? this.setActive(t - 1) : n < 0 && t !== e.length - 1 && this.setActive(t + 1))
          },
          ...
          observerContentScroll: function() {
            var t, e, i = this;
            this.data.sticky && (t = this.data.offsetTop, e = Object(n.b)().windowHeight, this.createIntersectionObserver().disconnect(), this.createIntersectionObserver().relativeToViewport({
              ...
              var n = e.boundingClientRect,
                a = n.top;
              n.bottom < i.navHeight || (n = 0 < e.intersectionRatio ? "top" : "", i.$emit("scroll", {
                scrollTop: a + t,
                isFixed: "top" == n
              }), i.setPosition(n))
            })))
