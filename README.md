...
## 使用教程 之 v1.1.0及以上版本软件启动方式
1. 新版下载，由于Gitee的Release大小限制，请前往 QQ群859098272群文件下载 或 [点我前往Github下载](https://github.com/ckkkf/sign-sign-in/releases/latest)

2. 双击main.exe运行即可


## 使用教程 之 v1.0.4及以上版本软件启动方式
